...
print('The most frequently occuring word is', most_frequent_word(hist)[0])
print('# of occurences', most_frequent_word(hist)[1])
# Tests for Exercise 3
newhist = build_histogram('two_cities.txt')
print(words_with_frequency(newhist,1))
print(words_with_frequency(newhist,2))